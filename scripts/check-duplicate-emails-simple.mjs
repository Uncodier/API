...
// Simular la configuración de Supabase
...
if (!supabaseUrl || !supabaseServiceKey) {
  console.log('\n📋 Para ejecutar este script, necesitas configurar las variables de entorno:');
  console.log('   - NEXT_PUBLIC_SUPABASE_URL');
  console.log('   - SUPABASE_SERVICE_ROLE_KEY');
  console.log('\n💡 Puedes crear un archivo .env.local con estas variables o ejecutar:');
  console.log('   export NEXT_PUBLIC_SUPABASE_URL="tu_url"');
  console.log('   export SUPABASE_SERVICE_ROLE_KEY="tu_key"');
  console.log('   node scripts/check-duplicate-emails-simple.mjs');
  process.exit(1);
}
...
async function checkDuplicateEmails() {
  console.log('\n🔍 Verificando emails duplicados en la base de datos...\n');
