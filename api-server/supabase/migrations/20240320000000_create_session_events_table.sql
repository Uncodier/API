...
DROP POLICY IF EXISTS "Enable read access for authenticated users" ON session_events;
DROP POLICY IF EXISTS "Enable insert for authenticated users" ON session_events;
