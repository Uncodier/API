    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f8fafc; line-height: 1.6;">
      ...
      <div class="email-card" style="max-width: 600px; margin: 40px auto; background-color: #fafafa; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 40px;">
          ...
          <!-- Channel Information -->
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">Contact Information</h3>
            <div style="background-color: #eff6ff; padding: 20px 24px; border-radius: 8px; border: 1px solid #bfdbfe;">
              <div style="margin-bottom: 12px;">
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 80px;">Channel:</span>
                <span class="email-text" style="color: #1e293b; font-size: 15px;">
                  ${channelIcons[data.channel as keyof typeof channelIcons]} ${channelNames[data.channel as keyof typeof channelNames]}
                </span>
              </div>
              <div style="margin-bottom: 12px;">
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 80px;">Name:</span>
                <span class="email-text" style="color: #1e293b; font-size: 15px;">${data.leadName}</span>
              </div>
              <div style="margin-bottom: 12px;">
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 80px;">Email:</span>
              ...
              <div style="margin-bottom: 12px;">
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 80px;">Phone:</span>
                <a href="tel:${data.contactInfo.phone}" style="color: #000000; font-weight: 600; text-decoration: none; font-size: 15px;">
                  ${data.contactInfo.phone}
                </a>
              </div>
              ` : ''}
              ...
              <div>
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 80px;">Method:</span>
                <span class="email-text" style="color: #1e293b; font-size: 15px;">${data.contactInfo.contact_method}</span>
              </div>
              ` : ''}
            </div>
          </div>
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">Messages</h3>
            ${data.userMessage ? `
          ...
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0; text-align: center;">
            <p class="email-muted" style="margin: 0; color: #64748b; font-size: 14px; line-height: 1.5;">
              This lead has been assigned to you and contacted through <strong class="email-text" style="color: #475569;">${channelNames[data.channel as keyof typeof channelNames]}</strong>.<br>
      ...
      try {
        ...
        const emailResult = await sendGridService.sendEmail({
          ...
          subject: (await import('@/lib/i18n/email-messages/platform')).platformT(
            locale,
            'lead_attention.subject',
            {
              leadName: leadInfo.name || 'New Lead',
