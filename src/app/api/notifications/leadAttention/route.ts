        ...
        <div style="padding: 40px;">
          ...
          <div style="margin-bottom: 32px;">
            ...
            <div class="email-panel" style="background-color: #f0f0f5; padding: 20px 24px; border-radius: 8px; border: 1px solid #e4e4e7;">
              ...
              <div>
                ...
                <span class="email-text" style="color: #111111; font-size: 15px;">${data.contactInfo.contact_method}</span>
              </div>
              ` : ''}
            </div>
          </div>
          ...
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0; text-align: center;">
            <p class="email-muted" style="margin: 0; color: #52525b; font-size: 14px; line-height: 1.5;">
              This lead has been assigned to you and contacted through <strong class="email-text" style="color: #111111;">${channelNames[data.channel as keyof typeof channelNames]}</strong>.<br>
