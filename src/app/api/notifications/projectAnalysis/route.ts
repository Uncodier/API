...
function generateTeamAnalysisNotificationHtml(data: {
  ...
  const renderInsight = (insight: typeof data.insights[0]) => `
    <div style="background-color: #f0f0f5; padding: 16px; border-radius: 6px; border: 1px solid #e4e4e7; margin-bottom: 12px;">
      <div style="display: flex; align-items: center; margin-bottom: 8px;">
        <h4 class="email-heading" style="margin: 0; color: #1e293b; font-size: 14px; font-weight: 600; flex: 1;">${insight.title}</h4>
        ${insight.impact ? `
      ...
      <p class="email-muted" style="margin: 0; color: #64748b; font-size: 13px; line-height: 1.5;">${insight.description}</p>
      ${insight.category ? `
        <div style="margin-top: 8px;">
          <span class="email-text" style="background-color: #f1f5f9; color: #475569; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 500;">
            ${insight.category}
          </span>
        </div>
      ` : ''}
      ...
      <div class="email-card" style="max-width: 600px; margin: 40px auto; background-color: #fafafa; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="padding: 40px;">
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">Site Information</h3>
            <div style="background-color: #eff6ff; padding: 20px 24px; border-radius: 8px; border: 1px solid #bfdbfe;">
              <div style="margin-bottom: 12px;">
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 100px;">Site:</span>
                <span class="email-text" style="color: #1e293b; font-size: 15px;">${data.siteName}</span>
              </div>
              <div style="margin-bottom: 12px;">
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 100px;">Analysis Type:</span>
                <span class="email-text" style="color: #1e293b; font-size: 15px; text-transform: capitalize;">${data.analysisType.replace('_', ' ')}</span>
              </div>
              <div>
                <span class="email-label" style="display: inline-block; font-weight: 600; color: #1e40af; min-width: 100px;">Total Insights:</span>
                <span class="email-text" style="color: #1e293b; font-size: 15px;">${data.insights.length}</span>
              </div>
            </div>
          </div>
          ...
          <!-- Analysis Summary -->
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">Analysis Summary</h3>
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">🔍 Key Findings</h3>
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">🔄 Changes Made</h3>
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">💡 Recommendations</h3>
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">⚠️ Alerts</h3>
          ...
          <div style="margin-bottom: 32px;">
            <h3 class="email-heading" style="margin: 0 0 16px; font-size: 18px; color: #1e293b; font-weight: 600;">📊 Affected Areas</h3>
            <div style="background-color: #fef3c7; padding: 20px 24px; border-radius: 8px; border: 1px solid #000000;">
