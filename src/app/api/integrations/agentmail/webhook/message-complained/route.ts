...
export async function POST(request: NextRequest) {
  try {
    ...
    const webhookSecret = process.env.AGENTMAIL_WEBHOOK_SECRET_MESSAGE_COMPLAINED;
    if (!webhookSecret) {
      console.error('❌ [AgentMail] AGENTMAIL_WEBHOOK_SECRET_MESSAGE_COMPLAINED not configured');
