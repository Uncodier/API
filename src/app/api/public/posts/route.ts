...
export async function GET(request: NextRequest) {
  try {
    ...
    if (siteId) {
      ...
      console.log('[API:public:posts] Resolving site context for URLs:', hostnamesArray);
      ...
      console.log('[API:public:posts] Supabase search result for site:', { sites, siteError, hostnamesSearched: hostnamesArray });
      ...
      if (!sites || sites.length === 0) {
        console.warn('[API:public:posts] Site not found for the provided URL:', { siteUrl, hostnamesSearched: hostnamesArray });
