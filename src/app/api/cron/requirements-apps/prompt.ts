...
- UI components MUST integrate with real backend APIs. Mocking data in the frontend is STRICTLY FORBIDDEN unless explicitly requested. Acceptance criteria must enforce end-to-end data flow.
