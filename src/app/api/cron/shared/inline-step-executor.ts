...
- CRITICAL EXECUTION RULES:
  ...
  8. GENERIC STEP CANCELLATION: If the step title or instructions are generically named (e.g., 'Step 1' with 'Execute step 1') without any concrete actionable context or objective, you MUST CANCEL the current plan immediately using the \`instance_plan\` tool with action='update', plan_id='${plan.id}', and status='cancelled'.
  9. DATABASE MIGRATIONS (CRITICAL):
