...
function renderBootstrapSpec(params: {
  ...
  return [
    ...
    '',
    '## 2. Audience',
    '_To be refined by the coordinator from the overview above._',
    '',
    '## 3. Goals',
    '_Derive from the overview; keep to 3–5 measurable goals._',
    '',
    '## 4. Non-goals',
    '_List explicitly excluded scope to prevent drift._',
    '',
    '## 5. Guidelines',
    ...
    '_Route map, navigation flow, data models, and API contracts. Flesh out in the first planning cycle to eliminate ambiguity._',
    '',
    '## 7. Acceptance',
    '_Concrete, observable acceptance criteria — anchored in routes, status codes, or verbs (returns/renders/inserts/redirects)._',
    '',
    '## 8. Base hint',
