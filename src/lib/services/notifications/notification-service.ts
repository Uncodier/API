          ...
          <div style="padding: 40px;">
            ...
            <div style="margin-bottom: 32px;">
              ...
              <div style="background-color: #eff6ff; padding: 20px 24px; border-radius: 8px; border: 1px solid #bfdbfe;">
                ...
                <div style="margin-bottom: 12px;">
                  ...
                  <span class="email-text" style="color: #1e293b; font-size: 15px;">${data.lead_info?.name || 'Unknown Lead'}</span>
                </div>
                <div style="margin-bottom: 12px;">
                ...
                <div>
                  ...
                  <span class="email-text" style="color: #1e293b; font-size: 15px;">${data.contact_info.contact_method}</span>
                </div>
                ` : ''}
              </div>
            </div>
            ...
            <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0; text-align: center;">
              <p class="email-muted" style="margin: 0; color: #64748b; font-size: 14px; line-height: 1.5;">
                This lead has been assigned to you and contacted through <strong class="email-text" style="color: #475569;">${channelNames[this.data.channel as keyof typeof channelNames]}</strong>.<br>
