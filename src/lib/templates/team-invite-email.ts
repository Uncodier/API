...
export function generateTeamInviteHtml(data: TeamInviteEmailData): string {
  ...
  return `
    ...
    <head>
      ...
      <title>You're Invited to Join ${data.siteName} on ${getCompanyName()}</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f8fafc; line-height: 1.6;">
      ...
      <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 32px 40px; text-align: center;">
          ...
          <p style="margin: 8px 0 0; color: rgba(255, 255, 255, 0.9); font-size: 16px; font-weight: 400;">Join ${data.siteName} team on ${getCompanyName()}</p>
        </div>
        ...
        <div style="padding: 40px;">
          ...
          <div style="margin-bottom: 32px; text-align: center;">
            ...
            <p style="margin: 0; font-size: 16px; color: #475569; line-height: 1.7;">
              You've been invited to join the <strong>${data.siteName}</strong> team on ${getCompanyName()}. 
          ...
          <!-- Features List -->
          <div style="margin-bottom: 32px;">
            <h3 style="margin: 0 0 20px; font-size: 18px; color: #1e293b; font-weight: 600;">What you can do with ${getCompanyName()}:</h3>
          ...
          <div style="text-align: center; margin: 40px 0 32px;">
            <a href="${getSignUpUrl(data.signUpUrl)}" 
          ...
          <div style="text-align: center; margin-bottom: 24px; padding: 20px; background-color: #f1f5f9; border-radius: 8px; border: 1px solid #e2e8f0;">
            <p style="margin: 0 0 12px; color: #475569; font-size: 14px;">
              <strong>New to ${getCompanyName()}?</strong> No worries! The sign-up process is quick and easy.
            </p>
            <p style="margin: 0; color: #475569; font-size: 14px;">
              Once you create your account, you'll automatically have access to ${data.siteName} with your assigned role.
            </p>
          </div>
          ...
          <div style="text-align: center; padding-top: 24px; border-top: 1px solid #e2e8f0;">
            <p style="margin: 0 0 12px; color: #64748b; font-size: 14px;">
              This invitation was sent to <strong>${data.memberEmail}</strong>
            </p>
      ...
      <div style="text-align: center; margin: 20px 0 40px;">
        <p style="margin: 0; color: #94a3b8; font-size: 12px;">
          Powered by <strong>${getBrandingText()}</strong> • ${getCompanyTagline()}
        </p>
      </div>
