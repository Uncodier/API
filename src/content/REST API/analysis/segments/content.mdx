...
description: Documentación para el API de recomendaciones de contenido personalizado basado en segmentos de audiencia
---
...
> 
> Esta API utiliza algoritmos avanzados de IA para recomendar el contenido más relevante
> para cada segmento de audiencia, maximizando tasas de conversión, engagement y satisfacción
> del usuario. Ideal para estrategias de marketing de contenidos y personalización web.
...
<UnifiedApiTester 
  ...
  description="Prueba el API de contenido para segmentos con tus propios parámetros."
