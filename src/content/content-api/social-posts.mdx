---
title: Social Posts
description: Access public social posts for your integrated applications.
---
...
### Get Public Social Posts <MethodChip method="GET" />
...
```http
GET /api/public/social-posts?limit=100
```
