---
title: All Content
description: Access all public content for your integrated applications.
---
...
### Get Public Content <MethodChip method="GET" />
...
```http
GET /api/public/content?limit=100&type=video
```
...
- `type` (optional): Filter by a specific content type (e.g., `blog_post`, `video`, `podcast`, etc.). If omitted, all types are returned.
