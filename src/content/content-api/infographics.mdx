---
title: Infographics
description: Access public infographics for your integrated applications.
---
...
The Infographics API allows external systems to fetch public infographics content from your Makinari site.

## Endpoints

### Get Public Infographics <MethodChip method="GET" />

Retrieves all published infographics for a specific site. The site is identified either by the `url` query parameter or by automatically detecting the request's `Origin` or `Referer` headers.

```http
GET /api/public/infographics?limit=100
```
