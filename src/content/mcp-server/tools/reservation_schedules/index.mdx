...
| days | string | JSON weekly windows. e.g. `{"monday": {"enabled": true, "start": "09:00", "end": "17:00", "breaks": [{"start": "13:00", "end": "14:00"}]}}`. Optional `breaks` skip lunch/blocked slots. |
...
- Optional `breaks` on a day (`[{ "start": "15:00", "end": "16:00" }]`) are excluded from bookable slots.
