...
| instructions | string | Overall instructions for the plan |
| expected_output | string | Overall expected output of the plan |
| success_criteria | array | Criteria for successful completion |
| validation_rules | array | Rules for validating the plan execution |
