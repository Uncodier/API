...
Manage sales orders. Use action="create" to create a sales record and optionally an order. Note: compatible discounts are applied automatically; you will receive any automatically applied discounts in the tool result, which you must communicate to the customer. Use action="update" to update an order. Use action="list" to search orders. Use action="delete" to remove an order.
