...
To use the MCP Server, you will need an API Key. Learn how to generate one in the [First API Request](/get-started/first-api-request) guide.
...
Makinari's MCP server exposes 60+ tools (CRM, messaging, commerce, media, platform). Names and params: [Tools catalog](/mcp-server/tools-catalog).
...
- [Tools Catalog](/mcp-server/tools-catalog) - Explore the list of available tools exposed by the server.
