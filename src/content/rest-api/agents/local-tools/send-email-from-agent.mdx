...
Envía correos electrónicos usando la configuración SMTP privada configurada para cada sitio. El tool obtiene automáticamente la configuración de email del sitio, incluyendo servidor SMTP, credenciales y puertos. Maneja el formato HTML del mensaje, la validación de emails y proporciona logging completo de los envíos.
...
| 400    | Bad Request     | Parámetros inválidos o formato de email incorrecto           |
