...
<UnifiedApiTester 
  apiType="general" 
  title="Prueba la API de Conversación"
  description="Utiliza este formulario para probar la API de Conversación con diferentes parámetros."
  defaultEndpoint="/api/conversation"
  defaultMessage="¿Qué problemas de SEO tiene mi sitio?"
